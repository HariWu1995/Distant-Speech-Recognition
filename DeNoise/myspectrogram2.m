% Slightly modified from original JOS's code
% Plots only positive frequencies and colormap for plot is changed
% Original source from https://ccrma.stanford.edu/~jos/sasp/Matlab_listing_myspectrogram_m.html 
function X = myspectrogram2(x,nfft,fs,window,noverlap,doplot,dbdown)
